# ===================================================================
# Module: VPC
# This configuration creates a VPC with public subnets for the ALB
...
resource "aws_nat_gateway" "nat" {
  ...
  # Ensure internet gateway is attached before creating NAT Gateway
...
resource "aws_route_table" "private" {
  ...
  # Route all traffic to NAT Gateway
  route {
    cidr_block     = "0.0.0.0/0"
